...
const SECTIONS: { label: string; body: string; href?: string }[] = [
  ...
  { label: "Workspace", body: "Name, logo, and workspace details." },
  { label: "Branding", body: "Make Otto look like your business." },
  { label: "Notifications", body: "Email and in-app alerts." },
  { label: "Users & Permissions", body: "Invite teammates and set roles." },
  { label: "API Keys", body: "Programmatic access to your workspace." },
  { label: "Integrations", body: "Connect the tools you already use." },
  { label: "Security", body: "Sessions, 2FA, and access controls." },
  { label: "Audit Log", body: "A record of every important change." },
  { label: "Danger Zone", body: "Export or delete your workspace." },
];
